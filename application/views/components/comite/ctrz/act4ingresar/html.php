...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('procedimientosCuarta/comiteIng/'.$estudiante[0]->id.'/'.$id_ctrz), 'class="form-horizontal" role="form" ') ?>
            <table class="form-group">
                <tr>
                    <td>
                        <h3 class="col-xs-11">1.  Interacción con pares.</h1>
                        <textarea class="col-xs-11" name="pregunta1" data-rel="tooltip" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p1resp)) echo $p1resp; ?></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <h3 class="col-xs-11">8.  Sociograma.</h1>
