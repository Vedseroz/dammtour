...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('DerivacionA21/comiteIng/'. $estudiante[0]->id .'/'. $id_drvz), 'class="form-horizontal" role="form"') ?>

            <div class="form-group">
                <h3>Descripción de situación:</h3>
                <textarea class="col-sm-8" name="actividades" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p1resp)) echo $p1resp; ?></textarea>
            ...
            <div class="form-group">
                ...
                <label class="col-sm-1 control-label" for="derivar">Derivar a: </label>
                    <select name="derivar" class="col-sm-3 chosen-select" data-placeholder="Seleccione...">
                    <option value="3" <?php if($derivar==3) echo 'selected'; ?> >Mediación escolar</option>
                    <option value="4" <?php if($derivar==4) echo 'selected'; ?> >Red interna </option>
                    <option value="5" <?php if($derivar==5) echo 'selected'; ?> >Red externa </option>
                </select>
            </div>

            <div class="form-group">
                <h3>Eficacia de las acciones realizadas:</h3>
                <textarea class="col-sm-8" name="eficacia" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p2resp)) echo $p2resp; ?></textarea>
                <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Obligatorio." title="" data-original-title="Condiciones">?</span>
            </div>

            <div class="form-group">
                <h3>Intervenciones:</h3>
                <textarea class="col-sm-8" name="intervenciones" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p3resp)) echo $p3resp; ?></textarea>
                <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Obligatorio." title="" data-original-title="Condiciones">?</span>
            </div>

            <div class="form-group">
                <h3> Instrumentos metodológicos: </h3>
                <textarea class="col-sm-8" name="instrumentos" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p4resp)) echo $p4resp; ?></textarea>
                <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Obligatorio." title="" data-original-title="Condiciones">?</span>
            </div>
