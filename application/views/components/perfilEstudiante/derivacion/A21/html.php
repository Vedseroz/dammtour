...
<div class="row">
    ...
    <h1 class="col-md-8 center">Segunda Actividad: Descripción de situación </h1>
</div> 
...
<div class="col-xs-12">
    <div class="row form-horizontal">
        <div class="form-group">
            <h2>Descripción de situación del estudiante</h2>
        </div>
                
        <div class="form-group">
            <h3>Actividades realizadas:</h3>
            <textarea class="col-sm-6" name="actividades" readonly="readonly"><?php echo $derivacion21[0]->actividades ?></textarea>
        </div> 

        <div class="form-group">
            <label class="col-sm-1 control-label" for="duracion">Duración: </label>
                <input name="duracion" readonly="readonly" type="text" id="duracion" class="col-sm-2" value="<?php 
                    if($derivacion21[0]->duracion == 1) echo 'Corto plazo';
                    if($derivacion21[0]->duracion == 2) echo 'Mediano plazo';
                    if($derivacion21[0]->duracion == 3) echo 'Largo plazo'
                ?>
                ">
            <label class="col-sm-1 control-label" for="duracion">Derivar a: </label>
                <input name="duracion" readonly="readonly" type="text" id="duracion" class="col-sm-2" value="<?php 
                    if($derivacion21[0]->prox_drvz == 3) echo 'Mediación escolar';
                    if($derivacion21[0]->prox_drvz == 4) echo 'Red interna';
                    if($derivacion21[0]->prox_drvz == 5) echo 'Red externa'
                ?>
                ">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="col-sm-6" name="eficacia" readonly="readonly"><?php echo $derivacion21[0]->eficacia ?></textarea>
        </div>

        <div class="form-group">
            <h3>Intervenciones:</h3>
            <textarea class="col-sm-6" name="intervenciones" readonly="readonly"><?php echo $derivacion21[0]->intervenciones ?></textarea>
        </div>

        <div class="form-group">
            <h3> Instrumentos metodológicos: </h3>
            <textarea class="col-sm-6" name="instrumentos" readonly="readonly"><?php echo $derivacion21[0]->instrumentos ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="vocacion" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"> <?php echo $derivacion21[0]->vocacion ?> </textarea>
        </div>
        ...
        <div class="form-group">
            <?php if($derivacion21[0]->perfil == 1) : ?>
            ...
            <?php elseif($derivacion21[0]->perfil == 2) : ?>
            ...
            <?php elseif($derivacion21[0]->perfil == 3) : ?>
        ...
        <div class="form-group">
            <ul id="dynamic-list">
                <?php if($derivacion21[0]->talento1 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->talento4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->talento2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->habilidad3 != NULL) : ?>
                ...
                <?php if($derivacion21[0]->habilidad4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->habilidad2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->talento5 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->talento3 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion21[0]->habilidad5 != NULL) : ?>
