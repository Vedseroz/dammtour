...
<div class="row">
    ...
    <h1 class="col-md-8 center">Tercera Actividad: Trabajos de fortalecimientos</h1>
</div> 
        ...
        <?php 
            if($tipo >= 2){
                ...
                if ($tipo == 4){
                    ...
                    echo ' <a href="'.$link_act3.'" class="btn btn-success"> <i class="ace-icon fa fa-pencil bigger-110"></i>Tercera Actividad</a>';
                }
                if ($tipo == 5){
...
<div class="col-xs-12">
    <div class="row form-horizontal">
        ...
        <div class="form-group">
            ...
            <textarea class="col-sm-6" name="actividades" ><?php echo $derivacion31[0]->actividades ?></textarea>
        </div>  
        ...
        <div class="form-group">
            ...
            <input name="duracion" readonly="readonly" type="text" id="duracion" class="col-sm-2" value="<?php 
                if($derivacion31[0]->duracion == 1) echo 'Corto plazo';
                if($derivacion31[0]->duracion == 2) echo 'Mediano plazo';
                if($derivacion31[0]->duracion == 3) echo 'Largo plazo'
                ?>
            ">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="col-sm-6" name="eficacia" readonly="readonly"><?php echo $derivacion31[0]->eficacia ?></textarea>
        </div>

        <div class="form-group">
            <h3>Intervenciones:</h3>
            <textarea class="col-sm-6" name="intervenciones" readonly="readonly"><?php echo $derivacion31[0]->intervenciones ?></textarea>
        </div>

        <div class="form-group">
            <h3> Instrumentos metodológicos: </h3>
            <textarea class="col-sm-6" name="instrumentos" readonly="readonly"><?php echo $derivacion31[0]->instrumentos ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="vocacion" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"> <?php echo $derivacion31[0]->vocacion ?> </textarea>
        </div>
        ...
        <div class="form-group">
            <?php if($derivacion31[0]->perfil == 1) : ?>
            ...
            <?php elseif($derivacion31[0]->perfil == 2) : ?>
            ...
            <?php elseif($derivacion31[0]->perfil == 3) : ?>
        ...
        <div class="form-group">
            <ul id="dynamic-list">
                <?php if($derivacion31[0]->talento1 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->talento4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->talento2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->habilidad3 != NULL) : ?>
                ...
                <?php if($derivacion31[0]->habilidad4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->habilidad2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->talento5 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->talento3 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion31[0]->habilidad5 != NULL) : ?>
