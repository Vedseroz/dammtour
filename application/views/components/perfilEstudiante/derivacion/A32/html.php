...
<div class="col-xs-12">
    <div class="row form-horizontal">
        <div class="form-group">
            <h2>Información de red externa</h2>
        </div>

        <div class="form-group">
            <h3>Información entregada:</h3>
            <textarea class="col-sm-6" name="info_entregada" readonly="readonly"><?php echo $derivacion32[0]->info_entregada ?></textarea>
            <label class="col-md-2 control-label" for="enviada">Enviado por:</label>
            <input name="enviada" data-rel="tooltip" readonly="readonly" id="enviada" class="col-md-2" value="<?php echo $derivacion32[0]->enviada ?>">
        </div>  

        <div class="form-group">
            <h3>Información Recibida:</h3>
            <textarea class="col-sm-6" name="info_recibida" readonly="readonly"><?php echo $derivacion32[0]->info_recibida ?></textarea>
            <label class="col-md-2 control-label"  for="enviada">Recibida por:</label>
            <input name="recibida" data-rel="tooltip" readonly="readonly" id="recibida" class="col-md-2" value="<?php echo $derivacion32[0]->recibida ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="vocacion" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"> <?php echo $derivacion32[0]->vocacion ?> </textarea>
        </div>
        ...
        <div class="form-group">
            <?php if($derivacion32[0]->perfil == 1) : ?>
            ...
            <?php elseif($derivacion32[0]->perfil == 2) : ?>
            ...
            <?php elseif($derivacion32[0]->perfil == 3) : ?>
        ...
        <div class="form-group">
            <ul id="dynamic-list">
                <?php if($derivacion32[0]->talento1 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->talento4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->talento2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->habilidad3 != NULL) : ?>
                ...
                <?php if($derivacion32[0]->habilidad4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->habilidad2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->talento5 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->talento3 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion32[0]->habilidad5 != NULL) : ?>
