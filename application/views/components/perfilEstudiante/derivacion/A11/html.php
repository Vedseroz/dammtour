...
<div class="row">
    ...
    <h1 class="col-md-8 center">Segunda Actividad: Actividades de orientación </h1>
</div> 
...
<div class="col-xs-12">
    <div class="row form-horizontal">
        <div class="form-group">
            <h2>Información de orientación </h2>
        </div>

        <div class="form-group">
            <h3>Actividades realizadas:</h3>
            <textarea class="col-sm-6" name="actividades" readonly="readonly"><?php echo $derivacion11[0]->actividades ?></textarea>
        </div>  
        ...
        <div class="form-group">
            ...
            <input name="duracion" readonly="readonly" type="text" id="duracion" class="col-sm-2" value="<?php 
                if($derivacion11[0]->duracion == 1) echo 'Corto plazo';
                if($derivacion11[0]->duracion == 2) echo 'Mediano plazo';
                if($derivacion11[0]->duracion == 3) echo 'Largo plazo'
                ?>
            ">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="col-sm-6" name="eficacia" readonly="readonly"><?php echo $derivacion11[0]->eficacia ?></textarea>
        </div>

        <div class="form-group">
            <h3>Intervenciones:</h3>
            <textarea class="col-sm-6" name="intervenciones" readonly="readonly"><?php echo $derivacion11[0]->intervenciones ?></textarea>
        </div>

        <div class="form-group">
            <h3> Instrumentos metodológicos: </h3>
            <textarea class="col-sm-6" name="instrumentos" readonly="readonly"><?php echo $derivacion11[0]->instrumentos ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="vocacion" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"> <?php echo $derivacion11[0]->vocacion ?> </textarea>
        </div>
        ...
        <div class="form-group">
            <?php if($derivacion11[0]->perfil == 1) : ?>
            ...
            <?php elseif($derivacion11[0]->perfil == 2) : ?>
            ...
            <?php elseif($derivacion11[0]->perfil == 3) : ?>
        ...
        <div class="form-group">
            <ul id="dynamic-list">
                <?php if($derivacion11[0]->talento1 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->talento4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->talento2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->habilidad3 != NULL) : ?>
                ...
                <?php if($derivacion11[0]->habilidad4 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->habilidad2 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->talento5 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->talento3 != NULL) : ?>
                    ...
                    <br>
                <?php endif ?>
                <?php if($derivacion11[0]->habilidad5 != NULL) : ?>
