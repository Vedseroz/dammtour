...
$(document).ready(function() {
	...
	.DataTable( {
        ...
        "serverSide": true,
		"ajax": {
            "url": "<?= site_url('PerfilEstudiante/getEstudiantes') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
            ...
            },
            {
	            ...
	            "render": function ( data, type, row ) {
	            	var link_edit = '<?= site_url('perfilEstudiante/mostrar') ?>/' + row.id;
	            	
	            	var options_normal = '<div class="hidden-sm hidden-xs action-buttons">';
	            	var edit_normal = '<a class="green" href="' + link_edit + '"><i class="ace-icon fa fa-search  bigger-130"></i></a>';
