    ...
    <div class="row form-horizontal">
        ...
        <div class="form-group">
            ...
            <?php if($actividad3d[0]->habilidad3 != "Sin Respuesta") : ?>
                <li><strong>Manejo de problemas y conflictos:</strong> No es posible evitar los conflictos, gracias a ellos se renuevan las oportunidades de cambiar y crecer, pero sí hay formas para llegar a acuerdos más rápido y entarlos como algo natural que es parte del crecimiento.</li>
                <br>
            <?php endif ?>
            ...
            foreach ($actividad3dapoyos as $apoyo) {
                echo '<div class="col-xs-8">';
                    echo '<div class="form-group">';
                        echo '<input name="apoyo" readonly="readonly" data-rel="tooltip" type="text" id="apoyo"  class="col-xs-8" value="' . $apoyo->apoyo. '">';
                    echo '</div>';
                echo '</div>';
            }
        ?>
