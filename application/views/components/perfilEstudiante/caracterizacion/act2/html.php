...
<div class="col-xs-12">
    <div class="row form-horizontal">
        ...
        <textarea name="vocacion" readonly="readonly" data-rel="tooltip" class="col-xs-9" placeholder="Escribe aquí tus comentarios"> <?php echo $actividad2d[0]->vocacion ?> </textarea>
        ...
        <div class="row">
            <?php 
            if(empty($archivos)) echo '<div class="row center"><h3>* Sin documentos</h3></div>';
            if(!empty($archivos)){
        ...
        <div class="row">
            <?php 
            if(empty($archivos2)) echo '<div class="row center"><h3>* Sin Audio</h3></div>';
            if(!empty($archivos2)){
