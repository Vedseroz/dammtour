...
<div class="col-xs-12">
    <div class="row form-horizontal">
        ...
        <table class="form-group">
            <tr>
                <td>
                    <h3 class="col-xs-11">1.  Interacción con pares.</h3>
                ...
                <td>
                    <h3 class="col-xs-11">2.  Interacciones con adultos.</h3>
            ...
            <tr>
                <td>
                    <h3 class="col-xs-11">3.  Integración al territorio.</h3>
                ...
                <td>
                    <h3 class="col-xs-11">4.  Tolerancia a la frustración.</h3>
            ...
            <tr>
                <td>
                    <h3 class="col-xs-11">5.  Aspectos positivos.</h3>
                ...
                <td>
                    <h3 class="col-xs-11">6.  Aspectos negativos.</h3>
            ...
            <tr>
                <td>
                    <h3 class="col-xs-11">7.  Mediación.</h3>
                ...
                <td>
                    <h3 class="col-xs-11">8.  Sociograma.</h3>
