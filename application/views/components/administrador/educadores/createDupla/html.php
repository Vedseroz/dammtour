<dir class="row center">
	<h2>Creación cuenta dupla psicosocial</h2>
	<a class="btn btn-app btn-pink no-click">
...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('administrador/createDupla'), 'class="form-horizontal" role="form"') ?>
