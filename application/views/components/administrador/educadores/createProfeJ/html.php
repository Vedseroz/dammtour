<dir class="row center">
	<h2>Creación cuenta de Usuario 1</h2>
	<a class="btn btn-app btn-primary no-click">
...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('administrador/createProfeJ'), 'class="form-horizontal" role="form"') ?>

        	<h3 class="header smaller lighter green">Datos de cuenta</h3>

            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right" for="username">Nombre de Usuario: </label>
                <div class="col-sm-8">
                    <input name="username" data-rel="tooltip" type="text" class="col-xs-10 col-sm-6" value="<?= set_value('username') ?>">
                    <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Identificador de inicio de seción, Obligatorio," title="" data-original-title="Condiciones">?</span>
                </div>
            </div>
                ...
                <div class="col-sm-8">
                    <div class="col-xs-10 col-sm-6">
                        <select id="colegiosselect" name="colegiosselect" class="chosen-select form-control">
                            ...
                            <option value="<?= $value->id ?>" <?php if($value->id == $colegioSelect) echo 'selected="selected"'; ?> ><?= $value->nombre ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right" for="curso">Curso: </label>
                <div class="col-sm-8">
                    <div class="col-xs-10 col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="nombres" data-rel="tooltip" type="text" id="nombres" class="col-xs-10 col-sm-6" value="<?= set_value('nombres') ?>">
                    <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Obligatorio." title="" data-original-title="Condiciones">?</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="apellidos" data-rel="tooltip" type="text" class="col-xs-10 col-sm-6" value="<?= set_value('apellidos') ?>">
                    <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Obligatorio." title="" data-original-title="Condiciones">?</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="phone" type="text" data-rel="tooltip" class="input-mask-phone col-xs-10 col-sm-6" value="<?= set_value('phone') ?>">
                </div>
            </div>
