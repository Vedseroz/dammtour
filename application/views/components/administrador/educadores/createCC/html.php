<dir class="row center">
	<h2>Creación cuenta de comite de convivencia</h2>
	<a class="btn btn-app btn-yellow no-click">
...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('administrador/createCC'), 'class="form-horizontal" role="form"') ?>
