...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('administrador/add_colegio'), 'class="form-horizontal" role="form"') ?>

            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="nombre">Nombre colegio: </label>
                <div class="col-sm-9">
                    <input name="nombre" data-rel="tooltip" type="text" id="nombre" placeholder="Nombre colegio" class="col-xs-10 col-sm-6" value="<?= set_value('nombre') ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input name="direccion" maxlength="200" data-rel="tooltip" type="text" id="direccion" placeholder="Dirección" class="col-xs-10 col-sm-6" value="<?= set_value('direccion') ?>">
