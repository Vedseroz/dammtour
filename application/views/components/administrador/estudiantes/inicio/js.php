...
$(document).ready(function() {
    ...
    .DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?= site_url('Administrador/ajaxEstudiante') ?>",
            "type": "POST"
        },
        "columnDefs": [
           {
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    var remove_normal = '<a class="red" title="Eliminar" href="#" data-toggle="modal" data-target="#deleteModal" data-id="' + row.id + '" data-rut="' + row.rut + '"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>';
                    ...
                    var remove_responsive = '<li><a href="#" data-toggle="modal" data-target="#deleteModal" data-id="' + row.id + '" data-rut="' + row.rut + '" class="tooltip-error" data-rel="tooltip" title="Eliminar"><span class="red"><i class="ace-icon fa fa-trash-o bigger-120"></i></span></a></li>';
    ...
    $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        modal.find('.delete-modal-codigo').text(rut);
...
function btnRemove(id) {
    $.ajax({
        url: "<?= site_url('/Administrador/ajaxRemoverEstudiante') ?>/" + id,
        type: 'get',                
        dataType: 'json',
            ...
            if(response.type === 'Successful') {
                if(response.name == 'Remove') {
                    $.gritter.add({
                        ...
                        text: 'Se ha eliminado con éxito el estudiante, rut ' + response.data.rut + '.',
                ...
                $.gritter.add({
                    ...
                    text: 'No existe el estudiante, es posible que ya se haya eliminado.',
