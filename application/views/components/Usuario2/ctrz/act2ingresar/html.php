...
<div>
    ...
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('caracterizacionSegundo/estudianteIng/'.$estudiante[0]->id.'/'.$id_ctrz),'class="form-horizontal" role="form" enctype="multipart/form-data"') ?>
            ...
            <h5>Elige el estado de ánimo con el que más te identificas en este momento</h5>      
            <br>
            <div class="form-group">
                <table width="40%">
                    <tr>
            ...
            <textarea name="vocacion" data-rel="tooltip" class="col-xs-8" placeholder="¿Con qué profesión te identificas?" <?php if(!empty($vocacion)) echo $vocacion; ?>></textarea>
