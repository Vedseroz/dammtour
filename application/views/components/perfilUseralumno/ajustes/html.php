<h2>Ajustes de cuenta de usuario</h2>
...
<div id="user-profile-3" class="user-profile row">
	<?= form_open_multipart(site_url('PerfilUseralumno/ajustes'), 'class="form-horizontal" role="form"') ?>
		...
		<div class="tabbable">
			...
			<div class="tab-content profile-edit-tab-content">
				<div id="edit-basic" class="tab-pane in active">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							...
							<?php if($this->ion_auth->in_group(9)) echo 
							'<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-address">Dirección</label>

								<div class="col-sm-8">
									<input class="col-xs-12 col-sm-10" type="text" id="form-field-adress" name="direccion" value="'?><?= $direccion ?><?php if($this->ion_auth->in_group(9)) echo' " />
								</div>
							</div>'
							?>
						</div>
				...
				<div id="edit-password" class="tab-pane">
					...
					<h3>La nueva contraseña tiene que tener un minimo de <?= $min_password_length?> caracteres</h3>
					&nbsp;
