...
$(document).ready(function() {
	...
	.DataTable( {
        ...
        "serverSide": true,
		"ajax": {
            "url": "<?= site_url('Derivacion/getEstudiantesjefe') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
            ...
            },
            {
	            ...
	            "render": function ( data, type, row ) {
	            	var link_edit = '<?= site_url('derivacionA/Usuario1ing') ?>/' + row.id;
	            	
	            	var options_normal = '<div class="hidden-sm hidden-xs action-buttons">';
	            	var edit_normal = '<a class="green" href="' + link_edit + '"><i class="ace-icon fa fa-pencil bigger-130"></i></a>';
					...
					var edit_responsive = '<li><a href="' + link_edit + '" class="tooltip-success" data-rel="tooltip" title="Editar"><span class="green"><i class="ace-icon fa fa-pencil-square-o bigger-120"></i></span></a></li>';
	...
	//$( '<a href="<?= site_url('centros_costo/add') ?>" class="btn btn-sm btn-success"><i class="ace-icon fa fa-plus"></i> Agregar</a>' ).insertAfter( ".tableTools-container" );
