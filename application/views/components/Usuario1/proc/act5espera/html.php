...
<div class="clearfix  center col-xs-12">
    <h2>Descripción familiar del estudiante </h2>
    <i class="ace-icon fa fa-clock-o fa-5x"></i>
    <h2>Esperando el ingreso por Apoderado</h2>
    ...
    <div class="row">
        ...
        <a href="<?= site_url('procedimientosQuinto/Usuario1ing/'. $estudiante[0]->id . '/' .$id_ctrz)?>" class="btn btn-info">
            <i class="ace-icon fa fa-undo bigger-110"></i>
