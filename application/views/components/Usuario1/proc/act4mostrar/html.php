...
<div class="row">
    ...
    <div class="col-xs-12">
        <h1>Información de conducta </h1>
            <table class="form-group">
                <tr>
                    <td>
                        <h3 class="col-xs-11">1.  Interacción con pares.</h1>
                        <textarea name="pregunta1" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta1 ?></textarea>
                    </td>
                    <td>
                        <h3 class="col-xs-11">2.  Interacciones con adultos.</h1>
                        <textarea name="pregunta2" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta2 ?></textarea>
                    </td>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h3 class="col-xs-11">3.  Integración al territorio.</h1>
                        <textarea name="pregunta3" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta3 ?></textarea>
                    </td>
                    <td>
                        <h3 class="col-xs-11">4.  Tolerancia a la frustración.</h1>
                        <textarea name="pregunta4" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta4 ?></textarea>
                    </td>
                </tr> 
                <tr>
                    <td>
                        <h3 class="col-xs-11">5.  Aspectos positivos.</h1>
                        <textarea name="pregunta5" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta5 ?></textarea>
                    </td>
                    <td>
                        <h3 class="col-xs-11">6.  Aspectos negativos.</h1>
                        <textarea name="pregunta6" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta6 ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h3 class="col-xs-11">7.  Mediación.</h1>
                        <textarea name="pregunta7" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta7 ?></textarea>
                    </td>
                    <td>
                        <h3 class="col-xs-11">8.  Socio grama.</h1>
                        <textarea name="pregunta8" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"><?php echo $actividad4d[0]->pregunta8 ?></textarea>
                    </td>
                </tr>          
            </table>
            ...
            <textarea name="vocacion" readonly="readonly" data-rel="tooltip" class="col-xs-11" placeholder="Escribe aquí tus comentarios"> <?php echo $actividad4d[0]->vocacion ?> </textarea>
            ...
            <div class="form-group">
                ...
                <?php elseif($actividad4d[0]->perfil == 2) : ?>
                ...
                <?php elseif($actividad4d[0]->perfil == 3) : ?>
            ...
            <div class="form-group">
                <ul id="dynamic-list">
                    <?php if($actividad4d[0]->talento1 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->talento4 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->talento2 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->habilidad3 != "Sin Respuesta") : ?>
                    ...
                    <?php if($actividad4d[0]->habilidad4 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->habilidad2 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->talento5 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->talento3 != "Sin Respuesta") : ?>
                        ...
                        <br>
                    <?php endif ?>
                    <?php if($actividad4d[0]->habilidad5 != "Sin Respuesta") : ?>
