...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('DerivacionA32/duplaIng/'. $estudiante[0]->id .'/'. $id_drvz), 'class="form-horizontal" role="form"') ?>

            <div class="form-group">
                <h3>Información entregada:</h3>
                <textarea class="col-sm-6" name="info_entregada" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p1resp)) echo $p1resp; ?></textarea>
                <label class="col-md-1 control-label" for="enviada">Enviado por:</label>
                  <input name="enviada" data-rel="tooltip" id="enviada" class="col-md-2" value="<?php if(!empty($p2resp)) echo $p2resp; ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="col-sm-6" name="info_recibida" placeholder="Escribe aquí tus comentarios"><?php if(!empty($p3resp)) echo $p3resp; ?></textarea>
                <label class="col-md-1 control-label" for="enviada">Recibida por:</label>
                  <input name="recibida" data-rel="tooltip" id="recibida" class="col-md-2" value="<?php if(!empty($p4resp)) echo $p4resp; ?>">
                  <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Obligatorios." title="" data-original-title="Condiciones">?</span>
            </div>
