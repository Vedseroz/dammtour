...
<div>
    ...
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('DerivacionA22/orientadorIng/'. $estudiante[0]->id .'/'. $id_drvz), 'class="form-horizontal" role="form" enctype="multipart/form-data"') ?>
            ...
            <div class="form-group">
                <label class="col-sm-1 control-label" for="duracion">Duración: </label>
                    ...
                    <option value="2" <?php if($duracion==1) echo 'selected'; ?> >Mediano plazo </option>
                    <option value="3" <?php if($duracion==1) echo 'selected'; ?> >Largo plazo </option>
                </select>
            </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    <div class="widget-box">
                        <div class="widget-header">
                            <h4 class="widget-title">Subir Registro de acuerdo</h4>
                        </div>
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <input type="file" class="form-control" name="userFileD" id="input-file">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="widget-box">
                        <div class="widget-header">
                            <h4 class="widget-title">Descargar Registro de acuerdo</h4>
                        </div>
                            ...
                            <div class="widget-main">
                                <label>
                                    <ul class="list-unstyled spaced2">
                                        <li><i class="ace-icon fa fa-circle green"></i> <b>Documento:</b><?php echo $nameFile ?></li>
                                    </ul>
                                </label>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <a <?php if($nameFileTrue == 1) echo 'href="'.site_url('DerivacionA22/downloadOrientador/'. $id_drvz).'"' ?> id="botonDescargar" class="btn btn-primary btn-block">Descargar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
