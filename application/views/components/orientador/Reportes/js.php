...
$(document).ready(function() {
    ...
    .DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?= site_url('Reportes_Orientador/Derivacion') ?>",
            "type": "POST",
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "searchable": false,
                render: function ( data, type, row ) {
                    return  '<a href="<?= site_url('Reportes_Orientador/downloadderiv/')?>'+ row.id +'" type="button" class="btn btn-info btn-sm"><i class="fa fa-download" aria-hidden="true"></i></a>'
                }
            }
        ],
        "order": [[ 1, "desc" ]],
