        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    if(row.etapa == '3') link_edit = '<?= site_url('procedimientosTercero/pieIng') ?>/' + row.id + '/' + row.id_ctrz;
                    if(row.etapa == '4') link_edit = '<?= site_url('procedimientosCuarta/Usuario1sp') ?>/' + row.id + '/' + row.id_ctrz;
                    if(row.etapa == '5') link_edit = '<?= site_url('procedimientosQuinto/apoderadoIng') ?>/' + row.id + '/' + row.id_ctrz;
