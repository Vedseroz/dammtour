...
<script>
    $(document).ready(function(){
        ...
        .DataTable({
            ...
            "processing":true,
            "ajax":{
                "url": "<?= site_url('Costo/getDatosCostos'); ?>",
                "type": "POST"
            },
            "columnDefs":[
                {
                ...
                "render": function(data,type,row){
                    ...
                    return'<a onclick="return confirm_modal('+row.pasajero_id+');" type="button" class="btn btn-danger rounded-pill" data-toggle="modal" data-target="#exampleModal" id = "'+row.pasajero_id+'"><i class="fa fa-times" aria-hidden="true"></i></a>'
