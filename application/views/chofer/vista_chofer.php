          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <ul>
                    <li>
                    <a href="<?php echo site_url('chofer/IngresarChofer')?>" class="btn btn-dark"><p>Ingresar Nuevo Chofer</p><i class="fa fa-plus" aria-hidden="true"></i></a>

                    <br>
                    <br>
                    <?php
                      // en este sector se carga la tabla con todos los pasajeros. 
                      $this->load->view('chofer/tabla_chofer');
                    ?>
