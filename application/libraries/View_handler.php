...
class View_handler {
	...
	public function view($controler_name, $view_name, $data = array()) {
		...
		//if($this->ion_auth->in_group(1)) $components->sidebar = $this->load->view('sidebar_admin', $this->data, true);
		//if($this->ion_auth->in_group(3)) $components->sidebar = $this->load->view('sidebar', $this->data, true);
		//if($this->ion_auth->in_group(array(4,5,6,7,8,9))) $components->sidebar = $this->load->view('sidebar4', $this->data, true);
