...
$lang['form_validation_required']		= '<i class="ace-icon fa fa-exclamation" style="color:red"></i> El campo {field} es obligatorio.';
...
$lang['form_validation_numeric']		= '<i class="ace-icon fa fa-exclamation" style="color:red"></i> El campo {field} solo puede contener números.';
