...
class Reportes_Orientador extends CI_Controller {
    private $data = array();
    ...
    //VIEW_HANDLER
        $this->view_handler->view('orientador', 'Reportes', $this->data);
    }
    ...
    public function downloadderiv($id = null){
        ...
        $filepath = './files/Reportes/drvz/Orientador/Derivación '.$id.' '.$ruta[0].' '.$ruta[1].'.pdf';
