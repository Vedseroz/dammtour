<?php
  ...
  function fraccion($nombre = NULL, $hoy = NULL, $actividad4d = NULL){

  $plantilla = '<body>
      <header class="clearfix">
        <div id="project">';
        $plantilla .= '<div id="project"><span>INGRESADO POR PROFESOR </span>'.$nombre['nombre']." ".$nombre['apellido'].'</div>
        <div id="project"><span>FECHA </span>'.$hoy.'</div>';
        $plantilla .= '</div>
      </header>
      <main>
      <br>
      <h1>Información de conducta</h1>
        <table>
          ...
          <tbody>
            <tr>
              <td class="campos">1. Interacción con pares.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta1'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">2. Interacciones con adultos.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta2'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">3. Integración al territorio.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta3'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">4. Tolerancia a la frustración.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta4'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">5. Aspectos positivos.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta5'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">6. Aspectos negativos.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta6'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">7. Mediación.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta7'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">8. Sociograma.</td>
              <td class="Respuestas">';
              $plantilla .= $actividad4d['pregunta8'].'</td>';
            $plantilla .= '</tr>
          </tbody>
        </table>
        <br>
        <h1>Vocación del estudiante</h1>
          <div>
            <p>';
            $plantilla .= $actividad4d['vocacion'].'</p>
          </div>
        <br>
        <h1>Perfil del estudiante</h1>
        <div>';
          if ($actividad4d['perfil'] == 1) {
        ...
        <div>
          <ul>';
            if($actividad4d['talento1'] != 'Sin Respuesta') 
              ...
              <br>';
            if($actividad4d['talento2'] != 'Sin Respuesta')
              ...
              <br>';
            if($actividad4d['talento3'] != 'Sin Respuesta')
              ...
              <br>';
            if($actividad4d['talento4'] != 'Sin Respuesta')
              ...
              <br>';
            if($actividad4d['talento5'] != 'Sin Respuesta')
            ...
            if($actividad4d['habilidad2'] != 'Sin Respuesta')
              ...
              <br>';
            if($actividad4d['habilidad3'] != 'Sin Respuesta')
              ...
              <br>';
            if($actividad4d['habilidad4'] != 'Sin Respuesta')
              ...
              <br>';
            if($actividad4d['habilidad5'] != 'Sin Respuesta')
