<?php
  ...
  function Plantilla($estudiante = null, $hoy, $id_ctrz = null, $habytal = null){ 
  ...
  $plantilla = '<body>
      <header class="clearfix">
        ...
        $plantilla .= '</div>
        <div id="project">';
        $plantilla .= '<div id="project"><span>CÓDIGO DE Procedimiento DE ORIGEN: </span>'.$id_ctrz.'</div>';
      ...
      <h1>Habilidades y talentos registrados: </h1>
        <table>
          <thead>
            <tr>
              ...
              <th class="campos">Etapa 2 <br>(Profesor <br>Jefe/Estudiante):</th>
              <th class="campos">Etapa 3 <br>(Educador <br>PIE):</th>
              <th class="campos">Etapa 4 <br>(Comité de <br>convivencia):<br></th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[1] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[12] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[23] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[2] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[13] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[24] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[3] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[14] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[25] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>  
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[4] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[15] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[26] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>  
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[5] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[16] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[27] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>  
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[6] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[17] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[28] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>  
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[7] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[18] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[29] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>  
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[8] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[19] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[30] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>    
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[9] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[20] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[31] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>    
            </tr>
            <tr>
              ...
              <td class="Respuestas">';
              if($habytal[10] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[21] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>
              <td class="Respuestas">';
              if($habytal[32] != 'Sin Respuesta'){
                $plantilla .='&#10004;';
              }
              $plantilla .= '</td>    
            </tr>
        ...
        <h1>Explicación de Habilidades y talentos seleccionadas:</h1>
        <ul>
          <li>Usuario 1/Estudiante
            <ul>';
              if($habytal[1] != 'Sin Respuesta') 
