  ...
  function getPlantilla($estudiante = null, $derivacion11 = null, $hoy = null){ 
  ...
  $plantilla = '<body>
      <header class="clearfix">
        ...
        <div id="company" class="clearfix">
          ...
          <br>';
        $plantilla .='<h1>Código de Derivación '.$derivacion11['id_derivacion'].'</h1>';
        $plantilla .= '</div>
        <div id="project">';
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td class="Respuestas">';
              $plantilla .= $derivacion11['actividades'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Duración: </td>
              <td class="Respuestas">';
              if($derivacion11['duracion'] == 1){
                $plantilla .= 'corto plazo </td>';
              }elseif ($derivacion11['duracion'] == 2) {
                $plantilla .= 'mediano plazo </td>';
              }elseif ($derivacion11['duracion'] == 3) {
            ...
            <tr>
              ...
              <td class="Respuestas">';
              $plantilla .= $derivacion11['eficacia'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Acciones previas: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion11['acciones'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Intervenciones: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion11['intervenciones'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Instrumentos metodológicos: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion11['instrumentos'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Vocación del estudiante: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion11['vocacion'].'</td>';
            $plantilla .= '</tr>
          </tbody>
        </table>
        <br>
        ...
        <div>
          <ul>';
            ...
            if($derivacion11['habilidad2'] != NULL)
              ...
              <br>';
            if($derivacion11['habilidad3'] != NULL)
              ...
              <br>';
            if($derivacion11['habilidad4'] != NULL)
              ...
              <br>';
            if($derivacion11['habilidad5'] != NULL)
