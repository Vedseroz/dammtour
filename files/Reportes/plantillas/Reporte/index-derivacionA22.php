  ...
  function getPlantilla($estudiante = null, $derivacion22 = null, $hoy = null){ 
  ...
  $plantilla = '<body>
      <header class="clearfix">
        ...
        <div id="company" class="clearfix">
          ...
          <br>';
        $plantilla .='<h1>Código de Derivación '.$derivacion22['id_derivacion'].'</h1>';
        $plantilla .= '</div>
        <div id="project">';
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td class="Respuestas">';
              $plantilla .= $derivacion22['actividades'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Duración: </td>
              <td class="Respuestas">';
              if($derivacion22['duracion'] == 1){
                $plantilla .= 'corto plazo </td>';
              }elseif ($derivacion22['duracion'] == 2) {
                $plantilla .= 'mediano plazo </td>';
              }elseif ($derivacion22['duracion'] == 3) {
            ...
            <tr>
              ...
              <td class="Respuestas">';
              $plantilla .= $derivacion22['eficacia'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Intervenciones: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion22['intervenciones'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Instrumentos metodológicos: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion22['instrumentos'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Vocación del estudiante: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion22['vocacion'].'</td>';
            $plantilla .= '</tr>
          </tbody>
        </table>
        <br>
        ...
        <div>
          <ul>';
            ...
            if($derivacion22['habilidad2'] != NULL)
              ...
              <br>';
            if($derivacion22['habilidad3'] != NULL)
              ...
              <br>';
            if($derivacion22['habilidad4'] != NULL)
              ...
              <br>';
            if($derivacion22['habilidad5'] != NULL)
