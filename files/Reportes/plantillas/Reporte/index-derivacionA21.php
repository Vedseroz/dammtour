  ...
  function getPlantilla($estudiante = null, $derivacion21 = null, $hoy = null){ 
  ...
  $plantilla = '<body>
      <header class="clearfix">
        ...
        <div id="company" class="clearfix">
          ...
          <br>';
        $plantilla .='<h1>Código de Derivación '.$derivacion21['id_derivacion'].'</h1>';
        $plantilla .= '</div>
        <div id="project">';
      ...
      <main>
      <h1>Descripción situación del estudiante</h1>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td class="campos">Descripción de situación: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion21['actividades'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Duración: </td>
              <td class="Respuestas">';
              if($derivacion21['duracion'] == 1){
                $plantilla .= 'corto plazo </td>';
              }elseif ($derivacion21['duracion'] == 2) {
                $plantilla .= 'mediano plazo </td>';
              }elseif ($derivacion21['duracion'] == 3) {
                $plantilla .= 'largo plazo </td>';     
              }              
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Derivar a: </td>
              <td class="Respuestas">';
              if($derivacion21['prox_drvz'] == 3){
                $plantilla .= 'Mediación escolar </td>';
              }elseif ($derivacion21['prox_drvz'] == 4) {
                $plantilla .= 'Red interna </td>';
              }elseif ($derivacion21['prox_drvz'] == 5) {
                $plantilla .= 'Red externa </td>';     
              }              
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Eficacia de las acciones realizadas: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion21['eficacia'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Intervenciones: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion21['intervenciones'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Instrumentos metodológicos: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion21['instrumentos'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Vocación del estudiante: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion21['vocacion'].'</td>';
            $plantilla .= '</tr>
          </tbody>
        </table>
        <br>
        ...
        <div>
          <ul>';
            ...
            if($derivacion21['habilidad2'] != NULL)
              ...
              <br>';
            if($derivacion21['habilidad3'] != NULL)
              ...
              <br>';
            if($derivacion21['habilidad4'] != NULL)
              ...
              <br>';
            if($derivacion21['habilidad5'] != NULL)
