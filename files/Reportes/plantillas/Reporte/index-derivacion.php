  ...
  function getPlantilla($estudiante = null, $derivacion1 = null, $hoy = null){ 
  ...
  $plantilla = '<body>
      <header class="clearfix">
        ...
        <div id="company" class="clearfix">
          ...
          <br>';
        $plantilla .='<h1>Código de Derivación: '.$derivacion1['id_derivacion'].'</h1>';
        $plantilla .= '</div>
        <div id="project">';
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td class="Respuestas">';
              $plantilla .= $derivacion1['situacion'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Razón: </td>
              <td class="Respuestas">';
              if ($derivacion1['razon'] == 1) {
                $plantilla .= 'habilidad/talento</td>';
              }else{
                $plantilla .= 'Convivencia</td>';
              }
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Justificación de la derivación: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion1['justificacion'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Acciones previas: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion1['acciones'].'</td>';
            $plantilla .= '</tr>
            <tr>
              <td class="campos">Vocación del estudiante: </td>
              <td class="Respuestas">';
              $plantilla .= $derivacion1['vocacion'].'</td>';
            $plantilla .= '</tr>
          </tbody>
        </table>
        <br>
        ...
        <div>
          <ul>';
            ...
            if($derivacion1['habilidad2'] != NULL)
              ...
              <br>';
            if($derivacion1['habilidad3'] != NULL)
              ...
              <br>';
            if($derivacion1['habilidad4'] != NULL)
              ...
              <br>';
            if($derivacion1['habilidad5'] != NULL)
