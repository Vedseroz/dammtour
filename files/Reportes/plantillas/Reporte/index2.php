<?php
  ...
  function getPlantilla($actividad2d = null, $estudiante = null, $hoy = null, $profe = null, $nombre = null){ 
  ...
  $plantilla = '<body>
      <header class="clearfix">
        ...
        <div id="company" class="clearfix">
          ...
          <br>';
        $plantilla .='<h1>Código de Procedimiento: '.$actividad2d['id_procedimientos'].'</h1>';
        $plantilla .= '</div>
        <div id="project">';
